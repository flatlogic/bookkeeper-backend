...
export class PostRefactoring1602063888238 implements MigrationInterface {
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (14, 'G30', 0, 2019, 'G30', 'l', 'njt', null, false, null, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (15, 'G31', 1, 2019, 'G31', 'i', 'jet', null, false, null, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (17, 'G 20183', 1, 2018, 'asd', 'i', 'njt', null, false, null, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (16, 'G 2019', 1, 2019, 'G 1029', 'i', 'et', null, false, null, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (18, 'S14', 1, null, 'Sub Acc', null, null, null, true, null, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (19, 'TTS', 1, null, 'test', null, null, null, true, 16, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (20, 'S15', 1, null, 'Tsdff', null, null, null, true, 15, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (22, 'AINT2', 1, 2019, 'AINT2', 'i', 'et', null, false, null, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (23, 'SAINT1', 1, null, 'SAINT1', null, null, null, true, 21, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (24, 'SAINT2', 1, null, 'SAINT2', null, null, null, true, null, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (25, 'SAINT3', 1, null, 'SAINT3', null, null, null, true, 22, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (26, 'SG2019', 1, null, 'SG 2019', null, null, null, true, 16, 2, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (27, '1600', 1, 2018, 'Construction Equipment!', 'a', null, 0.00, false, null, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (21, 'AINT1', 1, 2019, 'AINT1', 'l', 'njt', null, false, null, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (30, 'AINT3', 1, 2019, 'AINT3', 'l', 'jet', null, false, null, 10, false, null);`)
        await queryRunner.query(`INSERT INTO public.accounts (id, code, status, fiscal_year, description, type, restriction, end_year_adjustment_budget, is_subaccount, parent_id, company_id, is_posted, restriction_sub_type) VALUES (32, '1119', 1, 2019, 'test 1119', 'a', null, 0.00, false, null, 10, false, null);`)
        ...
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (21, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (22, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (23, 'ad', 'ad', 'asd', '12332', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (24, 'ad', 'ad', 'asd', '12332', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (25, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (26, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (10, 'testing street', 'Buckingham, Buckinghamshire', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (11, 'testing street', 'Buckingham, Buckinghamshire', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (12, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (13, 'N.Ordy 45, 197', 'Minsk', 'Minsk', '22004', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (9, 'Ordy', 'Berlin', 'Berlin', '42453', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (29, 'Ordy', 'Berlin', 'Berlin', '42453', '+375298595616');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (30, 'st. Zolny', 'Amsterdam', 'SB', '35223', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (31, 'st. Zolny', 'Amsterdam', 'SB', '35223', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (32, 'Test', 'City', 'State', '32433', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (33, 'Test', 'City', 'State', '32433', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (34, 'Street', 'City', 'State', '23434', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (35, 'Street', 'City', 'State', '23434', null);`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (27, 'Doutan', 'Bosnia', 'Genric', '34252', '212-323-1231');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (28, 'Doutan', 'Bosnia', 'Genric', '34252', '212-323-1231');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (36, 'N.Ordy 45, 197', 'Minsk', 'Minsk!', '22004', '213-123-2312');`)
        await queryRunner.query(`INSERT INTO public.addresses (id, street, city, state, zip_code, phone) VALUES (37, 'N.Ordy 45, 197', 'Minsk', 'Minsk!', '22004', '213-123-2312');`)
        ...
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (12, 'Primary Family', false, 1, 'Primary Family', 12, 13);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (29, 'Martin''s and CO', false, 1, 'Martin''s and CO', 27, 28);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (2, 'McDonalds', false, 1, 'McDonalds', null, null);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (1, 'Samon Bill', false, 1, 'Samon Bill', null, null);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (11, 'Alexx & Co', false, 1, 'Aladan & Co', 9, 29);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (30, 'Alan''s Organization', false, 1, 'Alan''s Organization', null, null);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (35, 'Trial Think', true, 1, 'Things for your mind', 30, 31);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (36, 'Arts galery', false, 1, 'Arts galery', null, null);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (37, 'New org for Russ', false, 1, 'New org for Russ', 32, 33);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (38, 'Test', true, 1, 'Test', null, null);`)
        await queryRunner.query(`INSERT INTO public.organizations (id, name, is_deleted, status, description, "physicalAddressId", "mailingAddressId") VALUES (39, 'Adrian''s company', false, 1, null, 34, 35);`)
        ...
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (2, 'Manager', 'Manager Role', 11, '{delete}', null);`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (1, 'Accountant', 'Accountant Role', 11, '{read,write}', '{read}');`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (4, 'Accountant', 'Accountant Role', 30, '{read,write}', '{read}');`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (5, 'Manager', 'Manager Role', 30, '{delete}', null);`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (8, 'Manager', 'Manager Role', 35, '{delete}', null);`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (9, 'Accountant', 'Accountant Role', 35, '{read,write}', '{read}');`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (10, 'Manager', 'Manager Role', 36, '{delete}', null);`)
        await queryRunner.query(`INSERT INTO public.roles (id, name, description, "organizationId", p_general_ledger, p_job_cost) VALUES (11, 'Accountant', 'Accountant Role', 36, '{read,write}', '{read}');`)
        ...
        await queryRunner.query(`INSERT INTO public.user_company_roles (id, role_id, company_id, user_id) VALUES (79, 1, 10, 87);`)
        await queryRunner.query(`INSERT INTO public.user_company_roles (id, role_id, company_id, user_id) VALUES (80, 1, 2, 87);`)
        await queryRunner.query(`INSERT INTO public.user_company_roles (id, role_id, company_id, user_id) VALUES (81, 1, 10, 88);`)
        await queryRunner.query(`INSERT INTO public.user_company_roles (id, role_id, company_id, user_id) VALUES (82, 1, 2, 88);`)
        await queryRunner.query(`INSERT INTO public.user_company_roles (id, role_id, company_id, user_id) VALUES (83, 1, 10, 90);`)
        ...
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (87, 10);`)
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (87, 2);`)
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (88, 10);`)
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (88, 2);`)
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (90, 10);`)
        await queryRunner.query(`INSERT INTO public.users_companies ("usersId", "companiesId") VALUES (90, 2);`)
        ...
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (84, 10);`)
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (85, 10);`)
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (86, 10);`)
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (87, 11);`)
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (88, 11);`)
        await queryRunner.query(`INSERT INTO public.users_organizations ("usersId", "organizationsId") VALUES (90, 11);`)
